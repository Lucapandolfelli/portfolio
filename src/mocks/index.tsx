...
export const projects: Array<Project> = [
  ...
  { id: 4, title: 'Proyecto del curso de Desarrollo Backend de Coderhouse', image: 'project4.png', githubLink: 'https://github.com/Lucapandolfelli/proyecto-final-desarrollo-backend-coderhouse', webLink: '', description: 'E-commerce desarrollado sobre Node.js con Express.js, utilizando como motor de plantillas EJS y estilizado con Bootstrap. Cuenta con registro, autenticación y logueo de usuarios, carrito de compras, generación de órdenes y chat de consulta entre los usuarios registrados. La persistencia de datos se realizó con mongoDB. Sistema de notificaciones al administrador con Nodemailer y Twilio.', technologies: ['Express.js', 'Node.js', 'mongoDB', 'Bootstrap', 'JWT'] },
  { id: 5, title: 'Filmboxd', image: 'filmboxd.png', githubLink: 'https://github.com/Lucapandolfelli/filmboxd', webLink: 'https://filmboxd-lucapandolfelli.vercel.app/', description: 'Aplicación web inspirada en la conocida plataforma Letterboxd, consumiendo la API de TMDB. Construida sobre el entorno de Next.js 13 y TypeScript, autenticación y logueo con NextAuth y persistencia en MongoDB.', technologies: ['Next.js', 'TailwindCSS', 'TypeScript', 'MongoDB'] },
  { id: 6, title: 'Luca Pandolfelli Photography', image: 'lpp.png', githubLink: 'https://github.com/Lucapandolfelli/lucapandolfelliphotography', webLink: 'https://photography.lucapandolfelli.com/', description: 'Página web para mi emprendimiento como fotógrafo equestre. Desarrollada con React.js y TailwindCSS, aun se encuentra en desarrollo. Implementación de imágenes WEBP para optimización del Networking.', technologies: ['React.js', 'TailwindCSS'] }
]
