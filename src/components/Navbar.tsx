...
export default function Navbar({}: Props) {
  ...
  return (
    <header className={showNavbar}>
      ...
      <nav className={ !toggleNavbar ? 'bg-[#1d1f25] fixed left-0 top-0 w-full h-full font-jetBrains flex justify-center transition-all duration-500 ease-in font-thin lowercase sm:hidden' : 'fixed left-[-100%]'}>
