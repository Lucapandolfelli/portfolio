  ...
  return (
    <Backdrop showModal={showModal} >
      <motion.div 
        ...
        <button className="absolute top-0 left-[calc(50%_-_7.5px)] bottom-[-120%] sm:block sm:bottom-[unset] sm:m-0 sm:left-[unset] sm:top-[-2rem] sm:right-[-2rem] transition-all duration-300 ease-in-out hover:scale-[1.05]" onClick={() => showModal(false)}><i className="fa-solid fa-xmark text-2xl"></i></button>
