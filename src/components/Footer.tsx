  ...
  return (
    <footer className='py-[2rem] text-center relative flex flex-col items-center gap-[1rem] border-t-[1px]'>
      <div className='flex justify-center gap-[.5rem]'>
        <Link className='flex justify-center items-center w-[40px] h-[40px] rounded-full bg-[#323640] p-[1rem] transition-all ease-linear duration-300 hover:bg-[#3C404D]' href='https://github.com/Lucapandolfelli' target={'_blank'} rel='noreferrer' aria-label='github'><i className="fa-brands fa-github-alt"></i></Link>
